...
//
// Adapted from the Supertonic reference Rust implementation:
//   https://github.com/supertone-inc/supertonic  (MIT License, (c) 2025 Supertone Inc.)
// Vendored here (unmodified engine logic) so the benchmark builds standalone.
